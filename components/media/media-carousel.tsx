      ...
      <div className="container mx-auto">
        ...
        <div className="relative px-4 md:px-8 lg:px-12">
          {canScrollLeft && (
            <button
              onClick={() => scroll('left')}
              className="from-background via-background/80 to-background/0 pointer-events-none absolute top-0 left-4 z-10 flex h-full items-center bg-linear-to-r px-2 opacity-0 transition-opacity group-hover/carousel:opacity-100 md:left-8 md:px-4 lg:left-12 [@media(hover:hover)]:pointer-events-auto"
          ...
          {canScrollRight && (
            <button
              ...
              className="from-background via-background/80 to-background/0 pointer-events-none absolute top-0 right-4 z-10 flex h-full items-center bg-linear-to-l px-2 opacity-0 transition-opacity group-hover/carousel:opacity-100 md:right-8 md:px-4 lg:right-12 [@media(hover:hover)]:pointer-events-auto"
